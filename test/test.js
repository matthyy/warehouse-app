...
describe('POST /api/games/search', function () {
    it('respond with json containing the game searched', function (done) {
        request(app)
...
describe('POST /api/games/search', function () {
    it('respond with json containing all games given no search term were added', function (done) {
        request(app)
            .post('/api/games/search')
            .set('Accept', 'application/json')
            .send()
